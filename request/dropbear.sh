...
echo -e "\033[1;32m $(fun_trans "INSTALADOR DROPBEAR ADM-ULTIMATE EDDYEPUMAS")\n$barra"
...
TTOTAL=($DPORT)
    for((i=0; i<${#TTOTAL[@]}; i++)); do
        ...
        echo -e "\033[1;33m $(fun_trans "Puerto Elegido:")\033[1;31m ${TTOTAL[$i]} FALLO"
        }
   done
  [[  -z $PORT ]] && {
  echo -e "\033[1;31m $(fun_trans "No se ha elegido ningun puerto válido")\033[0m"
  return 1
  }
